...
stress_score = st.slider('Stress Score (0-10)', 0, 10, 2)
sleep_duration = st.slider('Sleep Duration (hours)', 3.0, 10.0, 7.0, 0.1)
bmi = st.slider('BMI', 10.0, 45.0, 25.0, 0.1)
...
if hasattr(model, 'feature_names_in_'):
    ...
    expected_features = [
        ...
        'medication_beta_blocker', 'medication_diuretic', 'medication_other',
        'medication_unknown', 'medication_ace_inhibitor',
